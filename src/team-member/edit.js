...
function Edit( {
	...
	const { name, bio, url, alt, id, socialLinks, alignment, textColor, bioColor } = attributes;
	...
	const onBioColorChange = ( newBioColor ) => {
		setAttributes( { bioColor: newBioColor } );
	};
	...
	return (
		<>
			<InspectorControls>
				...
				<PanelColorSettings 
					title={ __( 'Content Settings', 'team-members' ) }
					...
					colorSettings={[
						{
							...
							label: __( 'Text Color', 'team-members' )
						},
						{
							value: bioColor,
							onChange: onBioColorChange,
							label: __( 'Bio Color', 'team-members' )
						}
					]}
				/>
			</InspectorControls>
